...
def get_next_signal_ids(count=1):
    """✅ جلب رقم واحد وإنشاء مجموعة أرقام متسلسلة"""
...
def send_crypto_signal(signal_id, coin_name, direction, strategy, entry, leverage, tp1, tp2, tp3, tp4, sl, summary_text, chart_buf=None, strength_score=0):
